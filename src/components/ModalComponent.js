...
// import { AreaModal, Button, ContainerImagemModal, ContainerModal, ImagemTopo, TextButton, TextoModal } from '../global/global';
const ModalComponent = ({ children, visivel, onPress, texto, imagem }) => {
  return (
    <Modal
      visible={visivel}
